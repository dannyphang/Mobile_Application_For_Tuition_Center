<%@ Page Title="" Language="C#" MasterPageFile="~/common/MasterPage/student.Master" AutoEventWireup="true" CodeBehind="payment.aspx.cs" Inherits="Tuition_Center_Application.common.User.payment" Async="true"%>
    ...
    <section id="content">
        ...
        <main>
            <div class="table-data">
                <div class="order">
                    <div class="head">
                        <h3>Monthly Tuition Fee: <a><asp:Label ID="title_label" runat="server" Text="Course123"></asp:Label></a></h3>
                            ...
                            <asp:Repeater ID="order_repeater" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="wrapper">
                                                <asp:LinkButton ID="delete_btn" runat="server" CssClass="icon delete" OnClick="next_btn_Click" data-no-blobity>
        ...
        <div class="payment">
            ...
            <asp:LinkButton ID="next_btn" runat="server" CssClass="next_btn" OnClick="next_btn_Click">Pay</asp:LinkButton>
        </div>
    </section>
