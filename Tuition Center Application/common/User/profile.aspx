<%@ Page Title="" Language="C#" MasterPageFile="~/common/MasterPage/student.Master" AutoEventWireup="true" CodeBehind="profile.aspx.cs" Inherits="Tuition_Center_Application.common.Student.profile" Async="true" %>
                                    ...
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-secondary mb-1">
                                                <asp:Label ID="age_label" runat="server" Text="18"></asp:Label>
                                            </p>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <asp:Label ID="school_label" runat="server" Text="SMK SCHOOL"></asp:Label>
                                            <asp:TextBox ID="school_text" runat="server" CssClass="hidden_text"></asp:TextBox>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <asp:Label ID="level_label" runat="server" Text="LEVEL"></asp:Label>
                                            <asp:TextBox ID="level_text" runat="server" CssClass="hidden_text"></asp:TextBox>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <asp:Button ID="edit_btn" runat="server" CssClass="btn btn-info edit_btn" Text="EDIT" OnClick="edit_btn_Click"/>
